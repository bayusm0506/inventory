...
<table width="750" border="0" align="center">
  <tr>
    <td><img src="../../mycss/images/.png" width="730" height="150" /></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<?php } ?>
        <tr>
          ...
          <td>Rp. <?php echo format_rupiah($total_harga); ?></td>
        </tr>
      </table></td>
  </tr>
  <td><br><span style='float:left; text-align:center;'> Gresik, <?php echo date('d-m-Y'); ?> <br/>
										Karyawan<br/></br></br>
								(.............................................)
								<br/><?php echo $nm_user; ?></span>
  <span style='float:right; text-align:center;'> Gresik, <?php echo date('d-m-Y'); ?> <br/>
										Outlet<br/></br></br>
								(.............................................)
